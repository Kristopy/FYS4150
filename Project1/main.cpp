...
int main(int argc, char* argv[]) {
    ...
    if (argv[3]){
        cout << "You have entered a third argument: Running LU" << "\n";
        ...
        cout << "Not running LU"<< "\n";
        cout << "--------------"<< "\n";
        cout << "If you want to run LU decomposition enter a arbitrary third argument, but keep in mind that the program will crash at n = 10^5" << "\n";
        exit(1);
    }
